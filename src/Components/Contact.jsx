                ...
                <div className='space-y-8'>
                    <div className='flex items-start'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-400'>Sangola ,Kola</p>
                        </div>
                    </div>
                     <div className='flex items-start'>
                        <div className='text-purple text-2xl mr-4'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-400'>pandharesanika62@gmail.com</p>
                        </div>
                    </div>
                     ...
                     <div className='flex items-start'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-400'>+91 8668214633</p>
                        </div>
                    </div>
                    <div className='pt-4'>
                       <h3 className='text-lg font-semibold mb-4'>Follow Me</h3>
                       <div className='flex space-x-4'>
                        <a href="https://github.com/Sanika-Pandhare" className='w-12 h-12 rounded-full bg-dark-300 flex items-center justify-center text-purple hover:bg-purple hover:text-white transtion duration-300'>
                            <FaGithub/>
                        </a>
                         
                         <a href="https://www.linkedin.com/in/sanika-pandhare-454319299/" className='w-12 h-12 rounded-full bg-dark-300 flex items-center justify-center text-purple hover:bg-purple hover:text-white transtion duration-300'>
                            <FaLinkedin/>
                        </a>
