...
function Hero() {
  return (
    ...
    viewport={{once:true}}
    id='home'
    className='min-h-screen flex items-center pt-20 pb-16 bg-gradient-to-r from-[#1a1a1a] via-[#2d2d2d] to-[#1a1aa]'
    >
        <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
            <div className='md:w-1/2 mb-10 md:mb-0'>
               <h1 className='text-4xl md:text-6xl font-bold mb-4'>
                Hi, i'm <span className='text-purple'>Sanika Pandhare</span>
               </h1>
             <h2 className="text-2xl md:text-4xl font-semibold mb-6 typewrite">
  Frontend Developer
</h2>
    ...
    Contact Me
            ...
            <div className='relative w-64 h-64 md:w-80 md:h-80'>
                <div className='absolute inset-0 rounded-full bg-gradient-to-r from-purple to-pink  opacity-70'>
                    ...
                    className='relative rounded-full w-64 h-64 md:w-80 md:h-80 object-cover z-10 'src={assets.profileImg} alt="profile"/>
