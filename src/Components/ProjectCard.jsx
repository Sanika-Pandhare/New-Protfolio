      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          {tech?.map((item, index) => (
            <span
              key={index}
              className="px-3 py-1 bg-dark-400 rounded-full text-5m"
            >
              {item}
            </span>
          ))}
        ...
        <div className="flex gap-2">
          ...
          <a
            href="#"  className="flex-1 text-center px-4 py-2 border border-purple rounded-lg font-medium rounded-lg hover:bg-purple/20 transition duration-300"
          > Code
          </a>
        </div>
      </div>
